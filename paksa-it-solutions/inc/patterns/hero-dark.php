<?php
/**
 * Paksa IT Solutions — Block Pattern: Hero Dark
 *
 * Dark background hero for high-impact entrances.
 * Use for product launches, major announcements, or premium landing pages.
 *
...
register_block_pattern(
    ...
    array(
        'title'      => __( 'Hero Dark', 'paksa-it-solutions' ),
        'categories' => array( 'paksa-hero' ),
        'keywords'   => array( 'hero', 'dark', 'dark background', 'premium' ),
        'viewport'   => array(
            'width'  => 1280,
            'height' => 600,
        ),
        'content'    => '<!-- wp:group {"className":"pk-hero pk-hero-dark","align":"full"} -->
<section class="pk-hero pk-hero-dark" aria-labelledby="pk-hero-dark-heading"><!-- wp:group {"className":"pk-hero-inner"} -->
<div class="pk-hero-inner"><!-- wp:group {"className":"pk-hero-content"} -->
...
<!-- wp:heading {"level":1,"className":"pk-hero-heading pk-animate-on-scroll","style":{"typography":{"fontSize":"clamp(2rem, 4vw, 3.25rem)","lineHeight":"1.1"},"spacing":{"marginBottom":"1rem"}},"textColor":"inverse"} -->
<h1 id="pk-hero-dark-heading" class="pk-hero-heading pk-animate-on-scroll" style="color:var(--pk-text-inverse);font-size:clamp(2rem, 4vw, 3.25rem);line-height:1.1;margin-bottom:1rem;" data-anim="fade-up" data-delay="100">' . esc_html__( 'Technology That Moves Business Forward', 'paksa-it-solutions' ) . '</h1><!-- /wp:heading -->

<!-- wp:paragraph {"className":"pk-hero-description body-large pk-animate-on-scroll","style":{"typography":{"fontSize":"1.125rem","lineHeight":"1.7"}},"textColor":"inverse-muted","metadata":{"dxActionId":""}} -->
...
<!-- wp:paragraph {"style":{"color":{"text":"#a0aec0"}}} -->
<p style="color:var(--pk-text-inverse-muted)">' . esc_html__( 'Enterprise Platform', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph --></div><!-- /wp:group -->
...
<!-- wp:paragraph -->
<p></p><!-- /wp:paragraph --></div><!-- /wp:group --></div><!-- /wp:group --></div><!-- /wp:group --></div><!-- /wp:group -->
...
<p class="pk-node pk-node-data">' . esc_html__( 'Data', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph --></div><!-- /wp:group --></div><!-- /wp:group --></div><!-- /wp:group --></section><!-- /wp:group -->',
    )
);
