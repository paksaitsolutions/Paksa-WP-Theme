<?php
/**
 * Paksa IT Solutions — Block Pattern: Services Categories
 *
 * Categorized service display in a card grid.
 * Each category card has an icon, title, description, and project count.
 *
...
register_block_pattern(
    ...
    array(
        'title'      => __( 'Services — Categories', 'paksa-it-solutions' ),
        'categories' => array( 'paksa-services' ),
        'keywords'   => array( 'categories', 'service types', 'grid', 'cards' ),
        'viewport'   => array(
            'width'  => 1280,
            'height' => 600,
        ),
...
<h2 class="pk-animate-on-scroll" style="font-size:clamp(1.5rem, 3vw, 2.25rem);line-height:1.15;margin-bottom:1rem;" data-anim="fade-up" data-delay="0">' . esc_html__( 'Service Categories', 'paksa-it-solutions' ) . '</h2><!-- /wp:heading -->
...
<p class="body-large pk-animate-on-scroll" style="color:var(--pk-text-secondary);font-size:1.125rem;line-height:1.7;" data-anim="fade-up" data-delay="100">' . esc_html__( 'Browse our services by category.', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph --></div><!-- /wp:group -->
...
<h3 class="pk-svc-category-title">' . esc_html__( 'Software Development', 'paksa-it-solutions' ) . '</h3><!-- /wp:heading -->

<!-- wp:paragraph {"className":"pk-svc-category-desc"} -->
<p class="pk-svc-category-desc">' . esc_html__( 'Custom software for web, mobile, and desktop platforms.', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"pk-svc-category-title"} -->
<h3 class="pk-svc-category-title">' . esc_html__( 'AI &amp; Data', 'paksa-it-solutions' ) . '</h3><!-- /wp:heading -->

<!-- wp:paragraph {"className":"pk-svc-category-desc"} -->
<p class="pk-svc-category-desc">' . esc_html__( 'Machine learning, analytics, and intelligent automation.', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"pk-svc-category-title"} -->
<h3 class="pk-svc-category-title">' . esc_html__( 'Cloud Solutions', 'paksa-it-solutions' ) . '</h3><!-- /wp:heading -->

<!-- wp:paragraph {"className":"pk-svc-category-desc"} -->
<p class="pk-svc-category-desc">' . esc_html__( 'Cloud migration, infrastructure, and DevOps services.', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"className":"pk-svc-category-title"} -->
<h3 class="pk-svc-category-title">' . esc_html__( 'IT Consulting', 'paksa-it-solutions' ) . '</h3><!-- /wp:heading -->

<!-- wp:paragraph {"className":"pk-svc-category-desc"} -->
<p class="pk-svc-category-desc">' . esc_html__( 'Strategic technology advisory and digital transformation.', 'paksa-it-solutions' ) . '</p><!-- /wp:paragraph -->

<!-- wp:html -->
<span class="pk-svc-category-count">15</span><!-- /wp:html --></div><!-- /wp:group --></div><!-- /wp:group -->',
    )
);
