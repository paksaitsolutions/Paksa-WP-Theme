<?php
/**
 * Paksa IT Solutions — Services: How We Work (Process)
 *
 * Reuses the exact same process step markup and CSS classes as the homepage
 * process section (template-parts/home/process.php).
 *
 * The homepage uses filter: paksa_process_steps
 * This section uses filter: paksa_svc_process_steps
 *
 * This allows the services page to have its own process steps if needed,
 * while sharing the same visual component. No CSS duplication.
 *
...
$desc    = apply_filters( 'paksa_svc_process_description', __( 'A structured approach that moves from business understanding to deployed, evolving technology.', 'paksa-it-solutions' ) );

/**
 * Filter: paksa_svc_process_steps
 * Defaults to the same steps as the homepage process.
 * Override this filter on the services page to customise steps.
 */
...
?>
<section class="section pk-process pk-svc-process" aria-labelledby="pk-svc-process-heading">
    <div class="container">
